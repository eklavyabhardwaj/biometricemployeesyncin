...
ERPNEXT_API_SECRET = 'bec5931806c7cc6'
...
IMPORT_START_DATE = 20240525 # format: '20190501'
...
devices = [
    {'device_id':'1','ip':'122.170.0.119', 'punch_direction': None, 'clear_from_device_on_fetch': False},
    {'device_id':'2','ip':'192.168.8.250', 'punch_direction': None, 'clear_from_device_on_fetch': False},
...
shift_type_device_mapping = [
    {'shift_type_name': ['Goregaon'], 'related_device_id': ['1']},{'shift_type_name': ['Day'], 'related_device_id': ['2']},{'shift_type_name': ['Mahape'], 'related_device_id': ['3']}
]
